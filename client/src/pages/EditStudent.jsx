  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setErrors({ submit: response.message || "Failed to update student" });
      }
    } catch (error) {
      console.error(error);
    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          ...
          <p className="text-warm-gray-600 text-sm">Loading student data...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="max-w-3xl mx-auto">
        <div className="bg-red-50 border border-red-200 rounded-xl p-8 text-center">
          ...
          <p className="text-sm text-warm-gray-600 mb-6">{loadError}</p>
          <button
